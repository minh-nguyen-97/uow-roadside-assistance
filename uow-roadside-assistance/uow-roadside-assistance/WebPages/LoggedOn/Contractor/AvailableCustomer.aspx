<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AvailableCustomer.aspx.cs" Inherits="uow_roadside_assistance.WebPages.LoggedOn.Contractor.AvailableCustomer" %>
...
<head runat="server">
    ...
    <%--title--%>
    <title>Contractor Available Customer</title>
    ...
    <link rel="stylesheet" href="../../../Css/LoggedOn/Contractor/AvailableCustomers.css" />
    ...
    <script type="text/javascript" src="../../../Scripts/LoggedOn/Contractor/AvailableCustomers.js"></script>
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th scope="col" style="width:30%">Response/Status</th>
                </tr>
            </thead>
            <tbody id="availableCustomersTable">
                <%--<tr>
                ...
                <tr>
                    ...
                    <td>$100</td>
                    <td>5</td>
                    <td><button class='btn btn-outline-primary' data-toggle='modal' data-target='#ModalCenter'>View Details</button></td>
                    <td>
                        <button id='declineButton' class='btn btn-danger responseButton' type='button'>Busy</button>
                        <button id='acceptButton' class='btn btn-success responseButton' type='button'>Accept</button>
                    </td>
                </tr>--%>
            </tbody>
        </table>
